...
<body>
    <h1>Cannot Add to Favorites!</h1>
    <h3>You Must be Logged in to Continue</h3>
    <a href ='$category.php#$item_id' style='color: #6d28d9;text-decoration: none;font-weight: 500;'>Click to Return</a>
</body>
</html>
");
}
if ($item_id > 0) {
    ...
    if (!empty($favorites))
    {
        echo "Couldn't add to favorites";
        exit;
    }
    else {
